...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  const handleSubmit = (e) => {
    ...
    //* Objeto Paciente
    //? Esta constante contiene los datos que se estan editando
    ...
    if (paciente.id) {
      //* Editando registro
      //? Se agrega la propiedad id al objetoPacienteid, el valor se le asigna por paciente id
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      >
        ...
        {error && <Error1 mensaje="Todos los campos son obligatorios" />}
        ...
        <div className="mb-5">
          ...
          <input
            id="email"
            type="email"
            placeholder="Email para contactarlo"
            className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md focus:outline-none focus:border-indigo-600"
            value={email}
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            className=" w-full p-2 mt-2 resize-none border-2 bg-gray-100 focus:outline-none   focus:border-indigo-600 rounded-md"
            value={sintomas}
